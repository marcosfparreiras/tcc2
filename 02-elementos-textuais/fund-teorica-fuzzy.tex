...
Com isto, ou um elemento pertence a um conjunto ou não. Já os conjuntos fuzzy permitem um grau de flexibilidade acerca do grau pertinência de cada elemento ao conjunto, sendo este grau definido por uma \textit{função de pertinência}. A definição formal de conjuntos fuzzy e funções de pertinência é dada por \citeonline[p.~14]{Jang1997} como:
\begin{align*}
