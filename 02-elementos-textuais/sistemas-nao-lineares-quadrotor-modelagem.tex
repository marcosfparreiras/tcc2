...
\begin{equation}
%v_i = \frac{\tau_i(V_c+v_i)+0.125\rho bcR_p^4\omega_{m\textunderscore i}^3C_d}{\omega_{m\textunderscore i}}
...
%A relação entre a velocidade angular em torno de cada eixo e a velocidade angular de 
%Os quatro rotores de um quadrotor são completamente independentes entre si