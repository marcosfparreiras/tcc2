...
\input{./02-elementos-textuais/desenvolvimento-desacoplamento}

\section{Controladores Fuzzy}
\label{sec:controlador-fuzzy}

%\input{./02-elementos-textuais/desenvolvimento-controlador-fuzzy}

\section{Controladores Neuro-Fuzzy}
\label{sec:controlador-neuro-fuzzy}

%\input{./02-elementos-textuais/desenvolvimento-controlador-neuro-fuzzy}
