...
\input{./06-quadros/resultados_2kg}

\input{./06-quadros/resultados_5kg}
...
\input{./06-quadros/resultados_2kg_ruidos}
...
%A sumarização dos resultados é feita nos Quadros \ref{qua:resultados_2kg_comparativo_fuzzy}, \ref{qua:resultados_5kg_comparativo_fuzzy} e \ref{qua:resultados_2kg_ruidos_comparativo_fuzzy} que sintetizam as respostas do sistema com massa $m=2$ kg