...
% O controlador neuro-fuzzy usado para garantir a estabilidade do quadrotor é mostrado na Figura \ref{fig:Rezazadeh2013_estrutura_anfis}, sendo esta a estrutura típica de uma arquitetura ANFIS para um sistema com duas entradas e uma saída.
%De fato, o módulo fuzzy produz ganhos proporcional e derivativo sendo que o primeiro é setado como um fator do segundo. A taxa desses ganhos é determinado posteriormente através de otimização multi-objetivo, usando um algoritmo genético sem elitismo.
...
\begin{figure}[!htb]
    ...
    \fonte{Adaptado de \citeonline{Rezazadeh2013}}
